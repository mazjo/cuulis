...
//
//                }
//                echo'<p style="color: #2b6777; font-weight: bold; text-align: center; margin-top: 0px; padding-top: 0px;">Voit siirtää ja muuttaa alueen kokoa!</p>';
...
//              
            ...
            <input type="text" class="kdate" style="margin-right: 10px; width: 20%; font-size: 0.8em; color: #2b6777"  name="paiva">';


                        echo'<b style="font-size: 0.8em; margin-right: 5px; color: ">Klo:</b>
    
               <input type="text" class="kelloE"  id="kelloE" name="kello" style="width: 20%; font-size: 0.8em; color: #2b6777" >';
...
//    
                ...
                if ($pisteet) {
                    echo '<tr style="border: 2px solid #2b6777; background-color: #73b9cc;  font-size: 1em" id="palaa"><th>Tehtävä</th><th>Tehtävän<br>pistemäärä</th><th>Tehdyt yht.</th><th>Tehty<br>ja osattu</th><th style="text-align: center; border: 1px solid #2b6777">Tehty,<br>mutta ei osattu<br>ilman apua</th><th>Toivottu yhdessä<br>läpikäytäväksi</th><th>Kommentoitu'
                    . '</th></tr>  </thead><tbody id="palaa2">';
                } else {
                    echo '<tr style="border: 2px solid #2b6777; background-color: #73b9cc;  font-size: 1em; " id="palaa"><th>Tehtävä</th><th>Tehdyt yht.</th><th>Tehty<br>ja osattu</th><th>Tehty,<br>mutta ei osattu<br>ilman apua</th><th>Toivottu yhdessä<br>läpikäytäväksi</th><th>Kommentoitu'
                    . '</th></tr>  </thead><tbody id="palaa2">';
                }
                    ...
                    if ($pisteet) {
                        ...
                        if ($rowt[aihe] == 1) {
                            ...
                            if ($onkoaihe != 1) {
                                ...
                                echo '<tr id="' . $rowt[jarjestys] . '" style=" font-size: 1em; background-color: #c8d8e4;"><td style="border: 2px solid #2b6777; border-right: none"></td><td colspan="6" style="border-top: 2px solid #2b6777;border-right: 2px solid #2b6777; border-bottom: 2px solid #2b6777; border-left: none"><a href="ykskohdat2.php?id=' . $ipid . '&tid=' . $rowt[id] . '"><b>' . $rowt[otsikko] . '</b><br></a>';
                            } else {
                                echo '<tr id="' . $rowt[jarjestys] . '" style=" font-size: 1em; background-color: #c8d8e4;"><td style="border: 2px solid #2b6777; border-right: none"></td><td colspan="6" style="border-top: 2px solid #2b6777;border-right: 2px solid #2b6777; border-bottom: 2px solid #2b6777; border-left: none"><b>' . $rowt[otsikko] . '</b><br>';
                            }
...
//       
                ...
                if (!$esta) {
                    ...
                    echo'<thead>';
                    echo '<tr style="border: 2px solid #2b6777; background-color: #73b9cc;  font-size: 1em">';
...
//                   echo'm: '.$monta;       
                        ...
                        if ($itsepisteytys) {
                            ...
                            if ($rowt[aihe] == 1 && $pisteet == 1) {
                                if ($rowt[aihekiinni] == 1) {
                                    echo '<tr style=" font-size: 1em; background-color: #c8d8e4"><td style="border: 2px solid #2b6777; border-right: none"></td><td colspan="5" style="background-color: #c8d8e4; border-bottom: 2px solid #2b6777; border-top: 2px solid #2b6777; border-left: none"><b>' . $rowt[otsikko] . '</b><br><br><b style="font-size:0.9em; margin-right: 20px; color: #e608b8">Tämä osio on suljettu</b></td><td style="background-color: #c8d8e4; border-bottom: 2px solid #2b6777; border-top: 2px solid #2b6777; border-right: 2px solid #2b6777"></td></tr>';
                                } else if (($rowt[aihekiinni] == 0 && $estaosio)) {
                                    ...
                                    echo '<tr style=" font-size: 1em; background-color: #c8d8e4"><td style="border: 2px solid #2b6777; border-right: none"></td><td colspan="5" style="background-color: #c8d8e4; border-bottom: 2px solid #2b6777; border-top: 2px solid #2b6777; border-left: none"><b>' . $rowt[otsikko] . '</b><br></td><td style="background-color: #c8d8e4; border-bottom: 2px solid #2b6777; border-top: 2px solid #2b6777; border-right: 2px solid #2b6777"></td></tr>';
                                }
                            } else if ($rowt[aihe] == 1 && $pisteet == 0) {
                                if ($rowt[aihekiinni] == 1) {
                                    echo '<tr style=" font-size: 1em; background-color: #c8d8e4" ><td style="border: 2px solid #2b6777; border-right: none"></td><td colspan="4" style="background-color: #c8d8e4; border-bottom: 2px solid #2b6777; border-top: 2px solid #2b6777; border-left: none"><b>' . $rowt[otsikko] . '</b><br><br><b style="font-size:0.9em; margin-right: 20px; color: #e608b8">Tämä osio on suljettu</b></td><td style="background-color: #c8d8e4;  border-bottom: 2px solid #2b6777; border-top: 2px solid #2b6777; border-right: 2px solid #2b6777 "></td></tr>';
                                } else if (($rowt[aihekiinni] == 0 && $estaosio)) {
                                    echo '<tr style=" font-size: 1em; background-color: #c8d8e4" ><td style="border: 2px solid #2b6777; border-right: none"></td><td colspan="4" style="background-color: #c8d8e4; border-bottom: 2px solid #2b6777; border-top: 2px solid #2b6777; border-left: none"><b>' . $rowt[otsikko] . '</b><br><br><b style="font-size:0.9em; margin-right: 20px; color: #e608b8">Tämä osio on sulkeutunut: ' . $sulkeutumispaiva2 . ', klo ' . $sulkeutumiskello2 . '</b></td><td style="background-color: #c8d8e4;  border-bottom: 2px solid #2b6777; border-top: 2px solid #2b6777; border-right: 2px solid #2b6777 "></td></tr>';
                                } else if (($rowt[aihekiinni] == 0 && $osiovapaa)) {
                                    echo '<tr style=" font-size: 1em; background-color: #c8d8e4" ><td style="border: 2px solid #2b6777; border-right: none"></td><td colspan="4" style="background-color: #c8d8e4; border-bottom: 2px solid #2b6777; border-top: 2px solid #2b6777; border-left: none"><b>' . $rowt[otsikko] . '</b><br><br><b style="font-size:0.9em; margin-right: 20px; color: #e608b8">Tämä osio sulkeutuu: ' . $sulkeutumispaiva2 . ', klo ' . $sulkeutumiskello2 . '</b></td><td style="background-color: #c8d8e4;  border-bottom: 2px solid #2b6777; border-top: 2px solid #2b6777; border-right: 2px solid #2b6777 "></td></tr>';
   ...
   WHERE itsetehtavat_id='" . $rowt[id] . "' AND kayttaja_id='" . $_SESSION["Id"] . "'
                            ...
                            if ($rowt[aihe] == 1 && $pisteet == 1) {
                                ...
                                if ($rowt[aihekiinni] == 1) {
                                    echo '<tr style=" font-size: 1em; background-color: #c8d8e4" ><td style="border: 2px solid #2b6777; border-right: none"></td><td colspan="3" style="background-color: #c8d8e4; border-bottom: 2px solid #2b6777; border-top: 2px solid #2b6777; border-left: none"><b>' . $rowt[otsikko] . '</b><br><br><b style="font-size:0.9em; margin-right: 20px; color: #e608b8">Tämä osio on suljettu</b></td><td style="background-color: #c8d8e4;  border-bottom: 2px solid #2b6777; border-top: 2px solid #2b6777; border-right: 2px solid #2b6777 "></td></tr>';
                                } else if (($rowt[aihekiinni] == 0 && $estaosio)) {
                                    echo '<tr style=" font-size: 1em; background-color: #c8d8e4" ><td style="border: 2px solid #2b6777; border-right: none"></td><td colspan="3" style="background-color: #c8d8e4; border-bottom: 2px solid #2b6777; border-top: 2px solid #2b6777; border-left: none"><b>' . $rowt[otsikko] . '</b><br><br><b style="font-size:0.9em; margin-right: 20px; color: #e608b8">Tämä osio on sulkeutunut: ' . $sulkeutumispaiva2 . ', klo ' . $sulkeutumiskello2 . '</b></td><td style="background-color: #c8d8e4;  border-bottom: 2px solid #2b6777; border-top: 2px solid #2b6777; border-right: 2px solid #2b6777 "></td></tr>';
                                } else if (($rowt[aihekiinni] == 0 && $osiovapaa)) {
                                    echo '<tr style=" font-size: 1em; background-color: #c8d8e4" ><td style="border: 2px solid #2b6777; border-right: none"></td><td colspan="3" style="background-color: #c8d8e4; border-bottom: 2px solid #2b6777; border-top: 2px solid #2b6777; border-left: none"><b>' . $rowt[otsikko] . '</b><br><br><b style="font-size:0.9em; margin-right: 20px; color: #e608b8">Tämä osio sulkeutuu: ' . $sulkeutumispaiva2 . ', klo ' . $sulkeutumiskello2 . '</b></td><td style="background-color: #c8d8e4;  border-bottom: 2px solid #2b6777; border-top: 2px solid #2b6777; border-right: 2px solid #2b6777 "></td></tr>';
